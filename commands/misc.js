...
smd({
        ...
        async(SLGxLEADER, msg, text) => {  let user = msg.sender.split('@')[0]  ; return await msg.reply( `https://wa.me/${user}` ); })
    //---------------------------------------------------------------------------
smd({
            pattern: "pick",
        ...
        async(SLGxLEADER, msg, match) => {
            if (!match) return msg.reply("*Which type of User you want?*");
            const groupMetadata = msg.isGroup ? await SLGxLEADER.bot.groupMetadata(msg.chat)
                .catch((e) => {}) : "";
...
//-----------------------------------------------------------------------------------
             // SLGxLEADER.bot.sendMessage(msg.chat, { react: { text: mokis,key: msg.key } })

    //---------------------------------------------------------------------------
smd({ on: "body" }, async(SLGxLEADER, msg,text,{icmd}) => {
