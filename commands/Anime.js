...
//-----------------------------------------------------------------------
smd({pattern: "waifu",desc: "To get Waifu Random Pics",category: "Anime Pics",filename: __filename },async(SLGxLEADER, msg, text , {cmdName}) => { console.log("Cmd : " , cmdName);   return await sendAnime(SLGxLEADER,msg ,'waifu' , text);});
//-----------------------------------------------------------------------
smd({pattern: "neko", category: "Anime Pics",desc: "Sends a Neko Image in chat",filename: __filename },async(SLGxLEADER, msg, text , {cmdName}) => { return await sendAnime(SLGxLEADER,msg ,'neko' , text);});
//-----------------------------------------------------------------------
smd({ pattern: "megumin",desc: "To get Waifu Random Pics",category: "Anime Pics",filename: __filename },async(SLGxLEADER, msg, text , {cmdName}) => { return await sendAnime(SLGxLEADER,msg ,'megumin' , text);});
//-----------------------------------------------------------------------
smd({ pattern: "loli",category: "Anime Pics",filename: __filename,desc: "Sends image of loli."},async(SLGxLEADER, msg) => {  return await sendAnime(SLGxLEADER,msg ,'loli',);});
//-----------------------------------------------------------------------
smd({pattern: "foxgirl",category: "Anime Pics",desc: "Sends image of Fox Girl Anime.", filename: __filename},async(SLGxLEADER, msg) => {  return await sendAnime(SLGxLEADER,msg ,'foxgirl',); });
//-----------------------------------------------------------------------
smd({pattern: "demon",alias : ["ds"],desc: "To get Naruto Random Videos",category: "Anime Pics",filename: __filename},async(SLGxLEADER, msg) => {  return await sendAnime(SLGxLEADER,msg ,'demon',); });
//------------------------------------------------------------------------
smd({pattern: "naruto",desc: "To get Naruto Random Videos",category: "Anime Pics",filename: __filename},async(SLGxLEADER, msg) => {  return await sendAnime(SLGxLEADER,msg ,'naruto',); });
//-------------------------------------------------------------------------
smd({pattern: "pokepic",category: "Anime Pics",filename: __filename,desc: "Sends image of pokemon."},async(SLGxLEADER, msg, text) => { return await sendGImages(msg ,text+"Pokemon Pics only HD ", `*---「 Poke Pic 」---*`, text );});
//-------------------------------------------------------------------------
smd({pattern: "animepic",category: "Anime Pics",filename: __filename,desc: "Anime images"},async(SLGxLEADER, msg, text) => { return await sendGImages(msg ,text+"Anime Pics HD", `*-----「 Anime Image 」-----*`, text );});
//-----------------------------------------------------------------------
smd({ pattern: "animewall",category: "Anime Pics",desc: "Anime Wallpaper Random",filename: __filename},async(SLGxLEADER, msg, text) => {return await sendGImages(msg ,text+"anime wallpaper for desktop full hd", `*---「 Anime Wallpaper 」---*` , text );});
//-----------------------------------------------------------------------
let qq = ["Anime News Today","New Anime","Uocoming Anime News","New Anime Info","Whats news in Anime","Anime Series","Manga News today","Anime New News","Anime News today",];smd({ pattern: "animenews",category: "Anime Pics", desc: "Sends Anime News in chat",filename: __filename},async(SLGxLEADER,msg,text,{cmdName}) => {let q1=qq[Math.floor(Math.random()*qq.length)]+text;return await sendAnime(SLGxLEADER,msg,cmdName, q1);});
//---------------------------------------------------------------------------
smd({pattern: "pokemon",category: "Anime Pics", filename: __filename, desc: "Sends info of pokemon in current chat."},async(SLGxLEADER, msg, text) => { if(!text) return msg.reply("*Uhh Please Give Me Poki Name/num*");try {let { data } = await axios.get(`https://pokeapi.co/api/v2/pokemon/${text}`);if (!data.name) return msg.reply(`❌ Could not found any pokemon with that name`);let poinfo = `*•Name: ${data.name}*\n*•Pokedex ID: ${data.id}*\n*•Height: ${data.height}*\n*•Weight: ${data.weight}*\n*•Abilities: ${data.abilities[0].ability.name}, ${data.abilities[1].ability.name}*\n*•Base Experience: ${data.base_experience}*\n*•Type: ${data.types[0].type.name}*\n*•Base Stat: ${data.stats[0].base_stat}*\n*•Attack: ${data.stats[1].base_stat}*\n*•Defense: ${data.stats[2].base_stat}*\n*•Special Attack: ${data.stats[3].base_stat}*\n*•Special Defense:${data.stats[4].base_stat}*\n*•Speed: ${data.stats[5].base_stat}*\n`;return await SLGxLEADER.bot.sendMessage(msg.chat, { image: { url: data.sprites.front_default }, caption: poinfo }, { quoted: msg });} catch (err) {  msg.reply("*_Ahh,Couldn't found any pokemon._*") }})
//---------------------------------------------------------------------------
...
async(SLGxLEADER, msg, text) => {
    ...
    SLGxLEADER.bot.sendMessage(msg.chat, {  image: {  url: srh.data[0].images.jpg.large_image_url,  }, caption: mang, }, {  quoted: msg,  });
...
async(SLGxLEADER, msg, text) => {
 ...
 SLGxLEADER.bot.sendMessage( msg.chat, { image: {  url: result.images.jpg.large_image_url, }, caption: details, }, { quoted: msg,});
}
   )
//---------------------------------------------------------------------------
