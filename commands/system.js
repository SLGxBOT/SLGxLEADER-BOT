...
smd({
        ...
        async(SLGxLEADER, msg, text) => {
         try{
            ...
            return await SLGxLEADER.bot.sendMessage(msg.chat, {image: { url: h },caption: `*_Scan Qr To Get You Text_*`,  } );
...
smd({
        ...
        async(SLGxLEADER, msg, text,{ isCreator}) => {
            ...
            try 
            {
                ...
                let pushnamer = SLGxLEADER.bot.getName(users);
