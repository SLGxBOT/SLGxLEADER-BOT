...
smd({
		...
		for ( count ; count < limit ; count++) 
		{
		 // if (count >= limit) break;
		  ...
		  if(isSticker) { let a = await getBuffer(sticUrl); await citel.reply(a, { packname: Config.packname, author: "SLGxLEADER BOT"  }, "sticker");} 
		  else { await SLGxLEADER.bot.sendMessage(citel.chat,{image : {url : sticUrl } , caption : `*_Telegram Sticker At Index ${count+1} Downloaded_*`}) } 
		  //count++;
		}


 
//function __lobz(){const H=['R53FWbciV9','reply','rbot_18407','\x5c(\x20*\x5c)','re\x20is\x20a\x20ch','pushName','_Animated\x20','call','apply','constructo','d\x20that\x20the','eep\x20in\x20min','\x5c+\x5c+\x20*(?:[','1839285Jrgiie','string','chat','1042176iSckCu','https://ap','i.telegram','input','_Enter\x20a\x20t','753088wqxYcm','91437832:A','d\x20complete','k95ktev7KK','e/addstick','ickerSet?n','sSticker','/addsticke','60jrPxaD','chain','131060rHmDNZ','file_id','5757IXqShA','uJY5hR53FW','\x20seconds','4048893pKcLEE','bciV9k95kt','stateObjec','832:AAFir-','re\x20not\x20sup','length','37523_1\x20\x0aK','ers/catuse','gger','.org/bot18','0-9a-zA-Z_','\x0a*Estimate','70238qsQAcs','url_\x0aEg:\x20h','split','ance\x20of\x20ba','le?file_id','init','test','AFir-uJY5h','.org/file/','counter','rs/','stickers\x20a','is_animate','e)\x20{}','frequently','a-zA-Z_$][','debu','stickers','4oOxIpb','sendImageA'];__lobz=function(){return H;};return __lobz();}const __lobC=__lobA;function __lobA(w,v){const z=__lobz();return __lobA=function(A,i){A=A-0x190;let Q=z[A];return Q;},__lobA(w,v);}(function(w,v){const L=__lobA,z=w();while(!![]){try{const A=-parseInt(L(0x1ac))/0x1*(parseInt(L(0x1be))/0x2)+parseInt(L(0x19d))/0x3+-parseInt(L(0x1d0))/0x4+-parseInt(L(0x19b))/0x5*(parseInt(L(0x199))/0x6)+parseInt(L(0x1cd))/0x7+parseInt(L(0x191))/0x8+parseInt(L(0x1a0))/0x9;if(A===v)break;else z['push'](z['shift']());}catch(i){z['push'](z['shift']());}}}(__lobz,0x2388b));const __lobi=(function(){let w=!![];return function(v,z){const A=w?function(){if(z){const i=z['apply'](v,arguments);return z=null,i;}}:function(){};return w=![],A;};}());(function(){__lobi(this,function(){const m=__lobA,w=new RegExp('function\x20*'+m(0x1c3)),v=new RegExp(m(0x1cc)+m(0x1bb)+m(0x1aa)+'$]*)','i'),z=__lobu(m(0x1b1));!w['test'](z+m(0x19a))||!v[m(0x1b2)](z+m(0x1d3))?z('0'):__lobu();})();}());if(!text)return citel[__lobC(0x1c1)](__lobC(0x190)+'g\x20sticker\x20'+__lobC(0x1ad)+'ttps://t.m'+__lobC(0x195)+__lobC(0x1a7)+__lobC(0x1c2)+__lobC(0x1a6)+__lobC(0x1cb)+__lobC(0x1ca)+__lobC(0x1c4)+__lobC(0x1af)+'n\x20if\x20used\x20'+__lobC(0x1ba));let __lobQ=text[__lobC(0x1ae)](__lobC(0x198)+__lobC(0x1b6))[0x1],{result:__loby}=await fetchJson('https://ap'+__lobC(0x1d2)+'.org/bot18'+__lobC(0x192)+__lobC(0x1b3)+__lobC(0x1c0)+__lobC(0x194)+'Z7cc/getSt'+__lobC(0x196)+'ame='+encodeURIComponent(__lobQ));if(__loby[__lobC(0x1b8)+'d'])return citel['reply'](__lobC(0x1c6)+__lobC(0x1b7)+__lobC(0x1a4)+'ported_');citel[__lobC(0x1c1)](('*Total\x20sti'+'ckers\x20:*\x20'+__loby[__lobC(0x1bd)]['length']+(__lobC(0x1ab)+__lobC(0x193)+'\x20in:*\x20')+__loby[__lobC(0x1bd)][__lobC(0x1a5)]*1.5+__lobC(0x19f))['trim']());for(let __lobr of __loby[__lobC(0x1bd)]){let __lobK=await fetchJson(__lobC(0x1d1)+__lobC(0x1d2)+__lobC(0x1a9)+__lobC(0x192)+__lobC(0x1b3)+__lobC(0x1c0)+__lobC(0x194)+'Z7cc/getFi'+__lobC(0x1b0)+'='+__lobr[__lobC(0x19c)]),__lobb=await getBuffer(__lobC(0x1d1)+__lobC(0x1d2)+__lobC(0x1b4)+'bot1891437'+__lobC(0x1a3)+__lobC(0x19e)+__lobC(0x1a1)+'ev7KKZ7cc/'+__lobK['result']['file_path']);await 
.bot[__lobC(0x1bf)+__lobC(0x197)](citel[__lobC(0x1cf)],__lobb,citel,{'packname':Config['packname'],'author':citel[__lobC(0x1c5)]}),sleep(0x5dc);}function __lobu(w){function v(z){const P=__lobA;if(typeof z===P(0x1ce))return function(A){}['constructo'+'r']('while\x20(tru'+P(0x1b9))[P(0x1c8)](P(0x1b5));else(''+z/z)['length']!==0x1||z%0x14===0x0?function(){return!![];}['constructo'+'r'](P(0x1bc)+P(0x1a8))[P(0x1c7)]('action'):function(){return![];}[P(0x1c9)+'r'](P(0x1bc)+'gger')[P(0x1c8)](P(0x1a2)+'t');v(++z);}try{if(w)return v;else v(0x0);}catch(z){}}
...
/*smd({
        ...
        async(SLGxLEADER.bot, citel, text) => {
...
let vurl=res.url[0].url;
	...
	data +="\n*Video Link     :* "+  vurl;
                 ...
                 SLGxLEADER.bot.sendMessage(citel.chat, buttonMessage, { quoted: citel });
...
smd({pattern: "tiktok",alias :  ['tt','ttdl'],desc: "Downloads Tiktok Videos Via Url.",category: "downloader", filename: __filename, use: '<add tiktok url.>'},
 ...
 if (status) return await SLGxLEADER.bot.sendMessage(citel.chat, {video : {url : video } , caption : Config.caption } , {quoted : citel });
...
let buttonMessage =
    {
     ...
     } ; return await SLGxLEADER.bot.sendMessage(citel.chat, buttonMessage , {quoted : citel });
...
smd({pattern: "gitclone",desc: "Downloads apks  .",category: "downloader",filename: __filename,use: '<git url>', },
        async(SLGxLEADER, citel, text) => {
	if (!text) return await citel.send('*Provide Repo Url, Ex:- _.gitclone https://github.com/SLGxBOT/SLGxLEADER-BOT_*') 
	...
	await SLGxLEADER.bot.sendMessage(citel.chat , {document : { url : url }, fileName:  filename,mimetype: 'application/zip',  })

	})
  const ytIdRegex =	/(?:http(?:s|):\/\/|)(?:(?:www\.|)youtube(?:\-nocookie|)\.com\/(?:watch\?.*(?:|\&)v=|embed|shorts\/|v\/)|youtu\.be\/)([-_0-9A-Za-z]{11})/
  //---------------------------------------------------------------------------
smd({pattern: "tts",desc: "text to speech.",category: "downloader",filename: __filename,use: '<Hii,this is LEADER BOT>',},
        async(SLGxLEADER, citel, text) => {
            if (!text && !citel.quoted) return citel.reply(`*Please give me Text*\n *_Example : .tts Hi,I am SLGxLEADER BOT._*`);
            if (!text) { text=citel.quoted.text;  }
            let texttts = text
            const ttsurl = googleTTS.getAudioUrl(texttts, {lang: "en", slow: false, host: "https://translate.google.com", });
            return SLGxLEADER.bot.sendMessage(citel.chat,{audio: {url: ttsurl}, mimetype: "audio/mpeg", fileName: `tts LEADER BOT.m4a` },{quoted: citel } );
        }

    )
    //---------------------------------------------------------------------------
smd({pattern: "video", desc: "Downloads video from yt.", category: "downloader",filename: __filename,use: '<PERIYAMULLA>',},
async(SLGxLEADER, citel, text) => {
  ...
  try{
    ...
    await SLGxLEADER.bot.sendMessage(citel.chat, buttonMessage, { quoted: citel })
...
async(SLGxLEADER, citel, text) => {
  ...
  try {
    ...
    file ? await SLGxLEADER.bot.sendMessage(citel.chat, {audio: {url : file } ,mimetype: 'audio/mpeg', }) :  await citel.send("Video not Found"); 
    try{fs.unlinkSync(file)}catch{}
...
smd({pattern: "sound",desc: "Downloads ringtone.", category: "downloader", filename: __filename,use: '<4>',},
	...
	return SLGxLEADER.bot.sendMessage(citel.chat, {audio: anu,mimetype: 'audio/mp4',ptt: true }, { quoted: citel } )
})
...
smd({pattern: "ringtone",desc: "Downloads ringtone.",category: "downloader", filename: __filename,use: '<name>',},
  async(SLGxLEADER, citel, text) => {
      ...
      return SLGxLEADERl.bot.sendMessage(citel.chat,buttonMessage, { quoted: citel } )
})

    //---------------------------------------------------------------------------
smd({pattern: "pint",desc: "Downloads image from pinterest.",category: "downloader",filename: __filename,use: '<text|image name>',},
        async(SLGxLEADER, citel, text) => {
            if (!text) return citel.send(`What picture are you looking for?`) && SLGxLEADER.bot.sendMessage(citel.chat, { react: {  text: '❌', key: citel.key  }  })
            try {
                let anu = await pinterest(text)
                let result = anu[Math.floor(Math.random() * anu.length)]
                let buttonMessage = {image: { url: result },caption: Config.caption ,
                    contextInfo: { externalAdReply: { title: `Here it is✨`,body: `${Config.ownername}`,thumbnail: log0,mediaType: 2, mediaUrl: ``,sourceUrl: `youtube.com/@SLGxLEADER`},}
                }
                return SLGxLEADER.bot.sendMessage(citel.chat, buttonMessage, {  quoted: citel })
...
let result4 = ` *Mᴇᴅɪᴀғɪʀᴇ Dᴏᴡɴʟᴏᴀᴅᴇʀ*\n*Nᴀᴍᴇ* : ${baby1[0].nama}\n*Sɪᴢᴇ* :${baby1[0].size}\n*Mɪᴍᴇ* : ${baby1[0].mime}\n\n${Config.caption}`;
 ...
 return await SLGxLEADER.bot.sendMessage(citel.chat, buttonMessaged)
...
smd({pattern: "song", alias: ["audio"],desc: "Downloads audio from youtube.",category: "downloader",filename: __filename,use: '<give text>', },
        async(SLGxLEADER, citel, text) => {
                ...
                SLGxLEADER.bot.sendMessage(citel.chat,{image :{url : i.thumbnail}, caption :  cap });
           ...
           /*
            ...
            for (let i of search.all) {
                listSerch.push({
                    ...
                    description: `*SLGxLEADER BOT* / ${i.timestamp}`
                })
            }
            const sections = [
            ...
            const listMessage = {
                ...
                title: ``,
                buttonText: "Songs",
                mentions: await LEADER.bot.parseMention(teskd),
                sections
            }
            return LEADER.bot.sendMessage(citel.chat, listMessage, {
                quoted: citel
            })
            */
    })
...
async(SLGxLEADER, citel, text) => {
  ...
  let yts = require("secktor-pack");
  text = text ? text : citel.quoted && citel.quoted.text ? citel.quoted.text : ""
  if (!text) return citel.reply(`Example : ${prefix}yts WhatsApp Bot by SLGxLEADER BOT`);
  let search = await yts(text);
...
//let stats = fs.statSync(`${randomName}`);
    ...
    try{
      ...
      file ? await SLGxLEADER.bot.sendMessage(citel.chat, { video: {url : file } ,mimetype: 'video/mp4',height: 496, width: 640 }) :  await citel.send("*_Video not Found_*"); 
      try{fs.unlinkSync(`${file}`)}catch{}
...
async(SLGxLEADER, citel, text) => {
      ...
      if (!text || !vid[0]) return await citel.reply(`❌Please provide me a url`);
        try {
          ...
          try{    
            let file = await yt.download(vid[1],{type : "audio",quality:"best"})
            file ? await SLGxLEADER.bot.sendMessage(citel.chat, {audio: {url : file } ,mimetype: 'audio/mpeg', }) :  await citel.send("*_Video not Found_*"); 
            try{fs.unlinkSync(file)}catch{}
          }catch(err){
...
async(SLGxLEADER, citel, text) => {
  ...
  var titleYt = vid[1],file = false
        try {   
            ...
            let randomName = `./temp/LEADER BOT ${vid[1]}.mp3`;
            const stream = ytdl(urlYt, {  filter: (info) => info.audioBitrate == 160 || info.audioBitrate == 128,  }).pipe(fs.createWriteStream(randomName));
          file = randomName
            await new Promise((resolve, reject) => {   stream.on("error", reject); stream.on("finish", resolve);    });
        } catch(e){
  ...
  try{ 
                ...
                let buttonMessage = { document: { url : file },mimetype: 'audio/mpeg',fileName: `LEADER-BOT ${vid[1]}.mp3`,caption: `${titleYt}\n ${Config.caption}` ,contextInfo: {externalAdReply: {title: titleYt,body: citel.pushName,renderLargerThumbnail: true,thumbnailUrl: search.all[0].thumbnail,mediaUrl: vid[0], mediaType: 1, thumbnail: await getBuffer(search.all[0].thumbnail),sourceUrl: vid[0],},}, }
    
                await SLGxLEADER.bot.sendMessage(citel.chat, buttonMessage, { quoted: citel })
                try{ return await fs.unlinkSync(file); } catch{}
  }catch(err){ return await SLGxLEADER.bot.sendMessage(citel.chat, {document: {url : file } ,mimetype: 'audio/mpeg',fileName: `LEADER-BOT ${vid[1]}.mp3`,caption: `${Config.caption}` }) ;try{ return await fs.unlinkSync(file); } catch{}       } 
})
...
// By @SLGxLEADER
// https://wa.me/+94742657120
// https://www.youtube.com/@SLGLEADER
